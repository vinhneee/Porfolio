      ...
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <Link
            href={href || ""}
            target="_blank"
            className="relative z-10 flex items-center space-x-2 whitespace-nowrap rounded-full bg-zinc-950 px-4 py-0.5 ring-1 ring-white/10"
          >
            <span className="relative z-20 inline-block whitespace-nowrap py-0.5 text-xs font-bold text-white">
              {title}
            </span>
